...
//#define WMTitleColorSelected [UIColor colorWithRed:0 green:0 blue:0 alpha:1]
//#define WMTitleColorNormal   [UIColor colorWithRed:96 green:96 blue:96 alpha:1]
//  导航菜单栏的背景颜色
#define WMMenuBGColor [UIColor colorWithRed:244.0/255.0 green:244.0/255.0 blue:244.0/255.0 alpha:1.0]
//#define WMMenuBGColor [UIColor colorWithRed:255 green:255 blue:255 alpha:1.0]
//  导航菜单栏的高度
#define WMMenuHeight  30
//  导航菜单栏每个item的宽度
#define WMMenuItemWidth 30
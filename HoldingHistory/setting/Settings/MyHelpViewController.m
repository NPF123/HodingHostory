...
- (void)showUI{
    ...
    for (int i = 0; i < 4; i++) {
        UIImageView *image = [LZXHelper creatImageViewWithFrame:CGRectMake(_scrollView.bounds.size.width*i, 0, _scrollView.bounds.size.width, _scrollView.bounds.size.height) imageName:[NSString stringWithString:arr[i]]];
